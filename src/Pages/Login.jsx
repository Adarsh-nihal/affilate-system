  ...
  return (
    <div className='flex w-full  md:h-[100vh] md:items-center md:justify-center p-0 overflow-hidden'>
      <form
        ...
        className="bg-white dark:bg-zinc-900 md:h-[80%] md:border md:border-[#FDB743] w-full p-2 md:w-[500px] h-full  md:rounded-2xl"
      >
          ...
          <div className="mt-10">
            <div className="relative">
              ...
              <input
                ...
                className="block w-full outline-none px-4 py-3 mt-2 text-zinc-800 bg-white border-2 rounded-lg dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-200 focus:border-yellow-500  "
